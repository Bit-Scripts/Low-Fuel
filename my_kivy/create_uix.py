...
class kivyUi():
    ...
    def gui_interface(self):
        ...
        self.addresse_label = ColoredLabel(
            ...
            color=utils.get_color_from_hex('#000000'), 
            background_color=(0.34509803921568627,0.34509803921568627,0.34509803921568627,.65), 
            size_hint=(.4,.2), 
            pos_hint={'x': .3, 'y': .4}, 
            border_width=1, 
            border_color=(0,0,0,1)
    ...
    def next_update(
        ...
        self.location = address_to_coord(
            self.user_address.street + ' ' + self.user_address.post_code + ' ' + self.user_address.city
            )
    ...
    def updateMapView(
        ...
        self.points.append(
            ...
            utils.get_color_from_hex('#00FFD4'))
            )
        ...
        for self.sellpoint in self.my_sell_points:
            ...
            self.points.append(
                (self.sellpoint.address[3], 
                self.sellpoint.address[4], 
                self.data_text, 
                self.color)
                )
