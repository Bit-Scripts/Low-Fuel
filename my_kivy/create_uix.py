...
class kivyUi():
    ...
    def gui_interface(self):
        ...
        self.mapview = MapView(lat=self.random_latitude, lon=self.random_longitude, zoom=12, map_source="osm", size_hint=(1, 1), cache_dir=self.tmp_dir)
    
        self.street_label = ColoredLabel(text="    Numéro et\nNom de la Rue", color=utils.get_color_from_hex('#000000'), background_color=(0.45098,0.64706,0.45098,1), size_hint=(.248,.098), pos_hint={'x': 0.0005, 'y': .9}, border_width=1, border_color=(0,0,0,1))
        self.street_entry = TextInput(size_hint=(.249,.05), pos_hint={'x': 0, 'y': .85})
        self.street_entry.bind(text=self.on_text)

        self.post_code_label = ColoredLabel(text=" Code\nPostal", color=utils.get_color_from_hex('#000000'), background_color=(0.45098,0.64706,0.45098,1), size_hint=(.082333333333,.098), pos_hint={'x': .25, 'y': .9}, border_width=1, border_color=(0,0,0,1))
        self.post_code_entry = TextInput(size_hint=(.082333333333,.05), pos_hint={'x': .25, 'y': .85})
        self.post_code_entry.bind(text=self.on_text_)

        self.city_label = ColoredLabel(text="Ville", color=utils.get_color_from_hex('#000000'), background_color=(0.45098,0.64706,0.45098,1), size_hint=(.16566667,.098), pos_hint={'x': .33333333, 'y': .9}, border_width=1, border_color=(0,0,0,1))
        self.city_DropDown = DropDown()
        self.city_button_DropDown = SmoothButton(text="Entrer le CP", size_hint=(.165666667, .048), pos_hint={'x': .33333333, 'y': .851}, color=(0,0,0,1), background_normal='', background_color=(.906,.906,.906,1), border_color=(0,0,0,1), border_width=1)
        ...
        self.radius_label = ColoredLabel(text="     Rayon\nd'action(km)", color=utils.get_color_from_hex('#000000'), background_color=(0.45098,0.64706,0.45098,1), size_hint=(.165666667,.098), pos_hint={'x': .5, 'y': .9}, border_width=1, border_color=(0,0,0,1))
        self.radius_entry = TextInput(size_hint=(.16566667,.05), pos_hint={'x': .5, 'y': .85})
        self.radius_entry.bind(text=self.on_text)

        self.addresse_label = ColoredLabel(text="Adresse Non trouvé", color=utils.get_color_from_hex('#000000'), background_color=(0.34509803921568627,0.34509803921568627,0.34509803921568627,.65), size_hint=(.4,.2), pos_hint={'x': .3, 'y': .4}, border_width=1, border_color=(0,0,0,1))
        self.essence_label = ColoredLabel(text="Type d'essence non correct", color=utils.get_color_from_hex('#000000'), background_color=(0.34509803921568627,0.34509803921568627,0.34509803921568627,.65), size_hint=(.4,.2), pos_hint={'x': .3, 'y': .4}, border_width=1, border_color=(0,0,0,1))
        
        self.fuel_DropDown = DropDown()
        self.btn_Gazole = SmoothButton(text='Gazole', size_hint_y=None, height=44, color=utils.get_color_from_hex('#000000'), background_normal='', background_color=(0.45098,0.64706,0.45098,1), border_color=(0,0,0,1), border_width=2)
        self.btn_Gazole.bind(on_release=lambda btn_Gazole: self.fuel_DropDown.select(self.btn_Gazole.text))
        self.btn_SP95 = SmoothButton(text='SP95', size_hint_y=None, height=44, color=utils.get_color_from_hex('#000000'), background_normal='', background_color=(0.45098,0.64706,0.45098,1), border_color=(0,0,0,1), border_width=2)
        self.btn_SP95.bind(on_release=lambda btn_SP95: self.fuel_DropDown.select(self.btn_SP95.text))
        self.btn_SP98 = SmoothButton(text='SP98', size_hint_y=None, height=44, color=utils.get_color_from_hex('#000000'), background_normal='', background_color=(0.45098,0.64706,0.45098,1), border_color=(0,0,0,1), border_width=2)
        self.btn_SP98.bind(on_release=lambda btn_SP98: self.fuel_DropDown.select(self.btn_SP98.text))
        self.btn_E85 = SmoothButton(text='E85', size_hint_y=None, height=44, color=utils.get_color_from_hex('#000000'), background_normal='', background_color=(0.45098,0.64706,0.45098,1), border_color=(0,0,0,1), border_width=2)
        self.btn_E85.bind(on_release=lambda btn_E85: self.fuel_DropDown.select(self.btn_E85.text))
        self.btn_E10 = SmoothButton(text='E10', size_hint_y=None, height=44, color=utils.get_color_from_hex('#000000'), background_normal='', background_color=(0.45098,0.64706,0.45098,1), border_color=(0,0,0,1), border_width=2)
        self.btn_E10.bind(on_release=lambda btn_E10: self.fuel_DropDown.select(self.btn_E10.text))
        self.btn_GPLc = SmoothButton(text='GPLc', size_hint_y=None, height=44, color=utils.get_color_from_hex('#000000'), background_normal='', background_color=(0.45098,0.64706,0.45098,1), border_color=(0,0,0,1), border_width=2)
        self.btn_GPLc.bind(on_release=lambda btn_GPLc: self.fuel_DropDown.select(self.btn_GPLc.text))
        self.button_DropDown = SmoothButton(text="Carburant utilisé", size_hint=(.16666667, .1425), pos_hint={'x': .6666667, 'y': .855}, color=utils.get_color_from_hex('#000000'), background_normal='', background_color=(0.45098,0.64706,0.45098,1), border_color=(0,0,0,1), border_width=2)
        ...
        self.submitButton = SmoothButton(text="Mettre à jour", size_hint=(.16416667, .1425), pos_hint={'x': .833333333, 'y': .855}, color=utils.get_color_from_hex('#000000'), background_normal='', background_color=(0.45098,0.64706,0.45098,1), border_color=(0,0,0,1), border_width=2) 
        ...
        self.bit_scripts_logo = GifImage(source = "image/Logo_Bit-Scripts.gif", size_hint=(.1, .1), pos_hint={'x': .01, 'y': .01})
    ...
    def on_text_(self, instance, value):
        if value != '' and len(value) == 5 and (str(int(value)) == value or '0'+ str(int(value)) == value):
            ...
            city = str(city).split(', ')
            if len(city) == 1:
                self.btn_city = SmoothButton(text=city[0], size_hint_y=None, height=22, color=(0,0,0,1), background_normal='', background_color=(.906,.906,.906,1), border=(0,0,0,1), border_color=(0,0,0,1), border_width=1)
                ...
                for index in range(len(city) - 1):
                    btn_city = SmoothButton(text=f'{city[index]}', size_hint_y=None, height=22, color=(0,0,0,1), background_normal='', background_color=(.906,.906,.906,1), border=(0,0,0,1), border_color=(0,0,0,1), border_width=1)
    ...
    def intermediate(self, street_entry, post_code_entry, city_DropDown, radius_entry, button_DropDown, addresse_label, essence_label):
        self.download_data_label = ColoredLabel(text="Récupération des données", color=(0,0,0,1), background_color=(0.34509803921568627,0.34509803921568627,0.34509803921568627,.65), size_hint=(.4,.2), pos_hint={'x': .3, 'y': .4}, border_width=1, border_color=(0,0,0,1))
        self.loading_label = ColoredLabel(text="Traitement des données", color=(0,0,0,1), background_color=(0.34509803921568627,0.34509803921568627,0.34509803921568627,.65), size_hint=(.4,.2), pos_hint={'x': .3, 'y': .4}, border_width=1, border_color=(0,0,0,1))
    ...
    def next_update(self, street_entry, post_code_entry, city_entry, radius_entry, fuel_entry, addresse_label, essence_label):
        ...
        if self.locator.geocode(self.address) is None or (self.street_entry_post == '' or self.post_code_entry_post == '' or self.city_entry_post == ''):
            ...
            for c in list(self.RootWidget.children):
                if c == self.addresse_label: self.RootWidget.remove_widget(self.addresse_label)
            if self.fuel_entry_post != 'Gazole' and self.fuel_entry_post != 'SP98' and self.fuel_entry_post != 'SP95' and self.fuel_entry_post != 'GPLc' and self.fuel_entry_post != 'E10' and self.fuel_entry_post != 'E85':
                ...
                for c in list(self.RootWidget.children):
                    if c == self.essence_label: self.RootWidget.remove_widget(self.essence_label)
    ...
    def updateMapView(self, street_entry, post_code_entry, city_entry):
        ...
        for self.sellpoint in self.my_sell_points:
            ...
            if self.sellpoint.name == self.parsejson.get_low_price_name():
               ...
               self.color = utils.get_color_from_hex('#736A7C')
